        ...
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.Img(
                            src=f'{os.getenv("SUBDOMAIN", "")}/assets/legend_arial.png'
                        ),
...
user_display_info = dbc.Card(
    dbc.CardBody(
        [
            dbc.Row(heading_with_info("Display info", "user_display_info_info")),
            dbc.Row(
                [
                    dbc.Col(
                        html.Img(
                        ...
                        [
                            dbc.Row(
                                [
                                    ...
                                    html.Label(0, id="user_displayed_genes"),
                                ]
                            ),
                            dbc.Row(
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.Label(0, id="user_displayed_targets"),
                                            html.Label("/"),
                                            html.Label(0, id="user_total_targets"),
                                        ],
                                        style={"display": "flex"},
                                    ),
                                ]
                            ...
                            dbc.Row(
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.Label(0, id="user_displayed_sources"),
                                            html.Label("/"),
                                            html.Label(0, id="user_total_sources"),
                                        ],
                                        style={"display": "flex"},
                                    ),
                                ]
